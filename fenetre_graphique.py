...
class Fenetre() :
    def __init__(self) :
        ...
        self.racine.geometry('300*200')
        # Lancement de la boucle événementielle 
        self.racine.mainloop()
        # Initialisation des attributs de la classe

        # Lancement des fonctions
        creer_widgets(self.racine)
    ...
    def creer_widgets(self, root) :
        ...
        self.curseur_qualité = tk.Scale(root, orient = 'horizontal', variable = var_qualité)
        ...
        self.fen_infos.geometry('300*200')
        ...
        self.fen_infos.entree_titre = tk.Entry(self.fen_infos, textvariable = var_titre )
        ...
        self.fen_infos.entree_genre = tk.Entry(self.fen_infos, textvariable = var_genre )
        ...
        self.fen_infos.entree_date = tk.Entry(self.fen_infos, textvariable = var_date )
        ...
        self.fen_infos.entree_real = tk.Entry(self.fen_infos, textvariable = var_real )
        self.fen_infos.entree_real.pack()

        self.fen_infos.bouton_imdb = tk.Button(self.fen_infos, text = 'Option charger depuis IMdB')
        self.fen_infos.bouton_imdb.bind('<Button-1>', charger_depuis_imdb)
